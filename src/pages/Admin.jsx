import { Edit3, PlusCircle, Search, Users, X, Trash2 } from "lucide-react";
        ...
        {filteredQuestions.map((question, index) => <div className="card" key={question.id}>
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              ...
              <button onClick={() => deleteQuestion(question.id)} className="btn-secondary text-xs text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/40 border-red-200 dark:border-red-900/50"><Trash2 size={16} /> O'chirish</button>
            </div>
          </div>
